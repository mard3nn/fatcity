...
if not game.IsDedicated() then
    ...
    hg.settings:AddOpt("Сервер", "hg_ragdollcombat", "Режим ходьбы в фейке")
    hg.settings:AddOpt("Сервер", "hg_movement_stamina_debuff", "Снижение выносливости")
    hg.settings:AddOpt("Сервер", "hg_furcity", "Фурр~~сити")
    hg.settings:AddOpt("Сервер", "hg_appearance_access_for_all", "Полный доступ к апиренсу", nil, nil, "bool")
    hg.settings:AddOpt("Сервер", "hg_healanims", "Анимации использования еды/медикаментов")
    hg.settings:AddOpt("Сервер", "hg_aimtoshoot", "Стрельба в стиле DarkRP (не работает)")
    hg.settings:AddOpt("Сервер", "hg_slings", "Система поясов для оружия")
end

hg.settings:AddOpt("Отладка", "hg_show_hitposmuzzle", "Показывать Hitposes")
hg.settings:AddOpt("Отладка", "hg_setzoompos", "Настройка положения зума оружия")
hg.settings:AddOpt("Отладка", "hg_show_hitbox", "Показывать хитбоксы")

hg.settings:AddOpt("Оптимизация", "hg_potatopc", "Режим слабого ПК")
hg.settings:AddOpt("Оптимизация", "hg_anims_draw_distance", "Дистанция анимаций TPIK", true, nil, "int")
hg.settings:AddOpt("Оптимизация", "hg_anim_fps", "FPS анимаций TPIK", nil, nil, "int")
hg.settings:AddOpt("Оптимизация", "hg_attachment_draw_distance", "Дистанция обвесов на оружия", true, nil, "int")
hg.settings:AddOpt("Оптимизация", "hg_maxsmoketrails", "Максимальное кол-во дымовых следов", nil, nil, "int")
...
hg.settings:AddOpt("Оружие", "hg_highpitchgunfire", "Высокие по тону звуки выстрелов внутри зданий")
...
hg.settings:AddOpt("Вид", "hg_cshs_fake", "Камера в фейке с C'SHServer")
hg.settings:AddOpt("Вид", "hg_gun_cam", "Оружейная камера (админы)")
hg.settings:AddOpt("Вид", "hg_nofovzoom", "Отключить смену поля зрения при прицеливании")
...
hg.settings:AddOpt("Звук", "hg_dmusic", "Динамическая музіка")
