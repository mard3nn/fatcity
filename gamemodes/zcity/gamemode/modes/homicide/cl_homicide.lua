...
MODE.TypeObjectives.standard = {
	...
	gunner = {
		objective = "Ты мирный со скрытым огнестрельным оружием. Ты поставил перед собой задачу помочь\nполиции быстрее найти преступника.",
		name = "Гражданин",
		color1 = Color(0,120,190),
		color2 = Color(158,0,190)
	},
	...
	innocent = {
		objective = "Ты мирный на месте убийства, хотя это случилось не с тобой, тебе лучше быть осторожным.",
		name = "Гражданин",
		color1 = Color(0,120,190)
	},
}
...
MODE.TypeObjectives.gunfreezone = {
	...
	gunner = {
		objective = "Ты гражданин на месте убийства, хотя это случилось не с тобой, тебе лучше быть осторожным.",
		name = "Гражданин",
		color1 = Color(0,120,190)
	},
